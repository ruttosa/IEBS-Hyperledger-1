...
function printHelp() {
  ...
  if [ "$USAGE" == "up" ]; then
    ...
    println "    -c <channel name> - Name of channel to create (defaults to \"channeluniversidades\")"
    ...
    println
    println " Examples:"
    println "   network.sh up createChannel -ca -c channeluniversidades -s couchdb -i 2.0.0"
